...
```{r}
ggplot(surveys_complete, aes(x = sex, y = weight, color = sex)) + geom_jitter() + labs(x = "Sex", y = "Body depth (mm)") + stat_summary(fun.data = "mean_se", color = "black")
```
```
